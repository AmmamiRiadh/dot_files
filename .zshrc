...
eval "$(oh-my-posh init zsh --config $HOME/.night-owl.omp.json )"
...
# disable tilde expansion (https://github.com/marlonrichert/zsh-autocomplete/issues/741#issuecomment-2537399929)
...
alias tdestroy="terraform destroy -auto-approve & disown"
alias tr="terraform"
unset completealiases
# User specific aliases and functions
PATH="$PATH:$HOME/.custom_scripts"
